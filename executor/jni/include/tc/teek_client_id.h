...
enum SVC_SECBOOT_CMD_ID {
    ...
    SECBOOT_CMD_ID_VERIFY_DATA_TYPE, /**< Secboot Task 校验，并传递SoC
                                        Type，校验成功解复位SoC*/
    SECBOOT_CMD_ID_VERIFY_DATA_TYPE_LOCAL, /**< Secboot Task原地校验，并传递SoC
                                              Type,校验成功解复位SoC*/
...
enum SVC_GLOBAL_CMD_ID {
    ...
    GLOBAL_CMD_ID_TERMINATE_CONTENT_PATH, /**< 安全服务Global，释放content
                                             path*/
...
enum SVC_CRYPT_CMD_ID {
    ...
    CRYPT_CMD_ID_CIPHER_AES_CBC_MAC,  /**< 对称加解密AES 128bits密钥 CBC_MAC模式
                                       */
    CRYPT_CMD_ID_CIPHER_AES_XCBC_MAC, /**< 对称加解密AES 128bits密钥
                                         XCBC_MAC模式 */
